...
/// The currency on a form: what is stored, shown as itself, with the list a
/// tap away. Deliberately not typeable — a currency that can be typed is a
/// currency that can be a typo, which is the whole of what this replaced.
class CurrencyField extends StatelessWidget {
  ...
  /// with a fallback: the Check is beside this field saying so, and quietly
  /// rewriting a committed Expense's currency would move it into a different
  /// month's total from an edit nobody made.
  final String value;
